...
*/
export declare type DataFieldForActionGroup = ComplexType & Omit<DataFieldAbstract, '$Type'> & {
...
/**
  Collection of OData actions and intent based navigations
*/
export declare type DataFieldWithActionGroup = ComplexType & Omit<DataField, '$Type'> & {
    ...
    */
    Actions: AnnotationTerm<DataFieldTypes[]>;
};
/**
...
*/
export declare type DoNotCheckScaleOfMeasuredQuantity = AnnotationTerm<Edm.Boolean>;
...
export declare type DataFieldAbstractTypes = AnnotationTerm<DataFieldForAnnotationTypes | DataFieldForActionAbstractTypes | DataFieldForActionGroupTypes | DataFieldTypes>;
...
export declare type DataFieldForActionGroupTypes = AnnotationTerm<DataFieldForActionGroup>;
export declare type DataFieldTypes = AnnotationTerm<DataField | DataFieldWithActionTypes | DataFieldWithIntentBasedNavigationTypes | DataFieldWithNavigationPathTypes | DataFieldWithUrlTypes | DataFieldWithActionGroupTypes>;
...
export declare type DataFieldWithActionGroupTypes = AnnotationTerm<DataFieldWithActionGroup>;
