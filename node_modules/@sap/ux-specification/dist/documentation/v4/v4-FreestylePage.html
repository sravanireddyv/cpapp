...
<script>
    ...
    var exports = {},
        floorPlanIcon;
    var treeData = {"name":"FreestylePage","description":"SAP Fiori elements for OData V4<br>@sap/ux-specification version 1.102.12","type":"schema","children":[{"name":"$filePath","children":[],"type":"string"}]};
</script>
