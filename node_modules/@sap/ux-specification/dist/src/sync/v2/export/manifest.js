...
function deletePage(manifestPage, configPages, configPage) {
    ...
    if ((configPage.pageType === ux_specification_types_1.PageType.ListReport || configPage.pageType === ux_specification_types_1.PageType.AnalyticalListPage) &&
...
function transformPageToNewManifestV2(pageId, configPages, manifestPage) {
    ...
    if (configPage.pageType === ux_specification_types_1.PageType.ListReport) {
