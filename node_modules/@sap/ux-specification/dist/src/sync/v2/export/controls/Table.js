...
__decorate([
    decoration_1.syncRule({
        manifest: {
            path: (pageName, _manifest, key) => application_1.getCreationFieldsPathV2(pageName, key)
        }
    }),
    decoration_1.validity({
        since: '1.77.0'
