...
function importFilterBar(listReportConfig, factory, importParameters, schemaDefinitions, pageKey) {
    listReportConfig.filterBar = factory.createInstance(ux_specification_types_1.PageType.ListReport, ux_specification_types_1.DefinitionName.ListReportFilterBar, listReportConfig.filterBar);
    ...
    if (schemaDefinitions['SelectionFields']) {
        listReportConfig.filterBar.selectionFields = factory.createInstance(ux_specification_types_1.PageType.ListReport, ux_specification_types_1.DefinitionName.ListReportFilterBar, listReportConfig.filterBar.selectionFields);
        ...
        for (const selectionProperty in schemaSelectionFields) {
            ...
            listReportConfig.filterBar.selectionFields[selectionKey] = factory.createInstance(ux_specification_types_1.PageType.ListReport, 'SelectionFieldDateSettings');
...
function addSettings(importParameters, listReportConfig, factory, pageKey) {
    ...
    listReportConfig.table = factory.createInstance(ux_specification_types_1.PageType.ListReport, tableType, listReportConfig.table);
    ...
    //Import ToolBar:
    listReportConfig.table.toolBar = factory.createInstance(ux_specification_types_1.PageType.ListReport, ux_specification_types_1.DefinitionName.ToolBar, {
        actions: {}
    });
    ...
    if (schemaDefinitions[ux_specification_types_1.DefinitionName.ActionsLR]) {
        for (const actionProperty in schemaDefinitions[ux_specification_types_1.DefinitionName.ActionsLR].properties) {
            ...
            listReportConfig.table.toolBar.actions[actionKey] = factory.createInstance(ux_specification_types_1.PageType.ListReport, ux_specification_types_1.DefinitionName.Action);
    ...
    if (footerAction) {
        for (const actionProperty in footerAction.properties) {
            const actionKey = index_1.convertActionKey(actionProperty);
            listReportConfig.footer.actions[actionKey] = factory.createInstance(ux_specification_types_1.PageType.ListReport, ux_specification_types_1.DefinitionName.FooterAction);
...
function createListReportConfig(importParameters) {
    ...
    //Instantiate Page
    const config = factory.createPageInstance(ux_specification_types_1.PageType.ListReport);
    const pageKeys = [];
    ...
    index_1.addFragments(config, importParameters.manifest, v2Page, ux_specification_types_1.PageType.ListReport, importParameters.fragments);
