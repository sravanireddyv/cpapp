 ...
 */
export declare function addFragments(config: LROPConfigsType, manifest: object, v2Page: v2.SapUiAppPageV2, pageType: PageType, fragments?: FileData[], objectPageSectionData?: ObjectPageSectionData): void;
