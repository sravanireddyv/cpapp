...
function findObjectPageV2(v2Pages, entitySet, pageKeys) {
    for (const key in v2Pages) {
        ...
        if (common_1.getPageTypeV2(v2Page.component.name) === ux_specification_types_1.PageType.ObjectPage && v2Page.entitySet === entitySet) {
            pageKeys.push(key);
            return v2Page;
        }
...
function findListReportPageV2(v2Pages, pageKeys) {
    for (const key in v2Pages) {
        const v2Page = v2Pages[key];
        pageKeys.push(key);
        if (common_1.getPageTypeV2(v2Page.component.name) === ux_specification_types_1.PageType.ListReport) {
            return v2Page;
        }
    }
}
...
function findAnalyticalListPage(v2Pages, pageKeys, logger) {
    for (const key in v2Pages) {
        const v2Page = v2Pages[key];
        pageKeys.push(key);
        if (common_1.getPageTypeV2(v2Page.component.name) === ux_specification_types_1.PageType.AnalyticalListPage) {
            return v2Page;
        }
    }
    //Not found ==> log
