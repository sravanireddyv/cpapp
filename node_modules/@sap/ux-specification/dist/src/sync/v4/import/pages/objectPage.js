    ...
    if (typeof actions === 'object') {
        ...
        for (const actionKey in actions.properties) {
            ...
            if (typeof definition === 'object' && definition.$ref) {
                ...
                const key = common_1.getDefinitionKey(actionDefinition.$ref);
...
function fillObjectPageConfig(importParameters, v4Page, factory) {
    ...
    if (manifestSettings) {
        ...
        fillHeaderFooterActions(importParameters.jsonSchema, objectPageConfig, factory, importParameters.manifest, importParameters.routingId, ux_specification_types_1.DefinitionName.HeaderActions, ux_specification_types_1.PropertyName.header);
