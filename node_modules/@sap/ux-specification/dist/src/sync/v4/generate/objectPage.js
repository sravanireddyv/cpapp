 ...
 */
function addRelatedFacetKeysType(generateParameters, schema, entitySetName, pages) {
    Object.keys(pages).forEach((element) => {
        if (pages[element].options &&
            ...
            const facetSections = common_1.getObjectPageFacetSection(generateParameters.entitySet.entityType, generateParameters.serviceAVT, generateParameters.logger);
