...
function addFieldsType(appSchema, entityType, floorplanSuffix = '') {
    ...
    const fieldPathRef = `${ux_specification_types_1.DefinitionName.FieldPath}${__1.prepareRef(floorplanSuffix)}`;
    ...
    const fields4Dialog = appSchema.definitions[`${ux_specification_types_1.DefinitionName.Fields4Dialog}${floorplanSuffix}`];
