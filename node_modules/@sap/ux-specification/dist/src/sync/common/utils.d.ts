...
import type { Manifest, ExtensionLogger, anyFacetType, FacetConfig, FacetConfigs, FacetSection, FileData, SchemaFilePath } from '@sap/ux-specification-types';
import { TemplateType, v4, FioriElementsVersion, PageType, PageTypeV4, SchemaType } from '@sap/ux-specification-types';
import type { DataField, DataFieldAbstractTypes } from '@sap-ux/vocabularies-types/vocabularies/UI';
